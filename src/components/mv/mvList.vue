  ...
  methods: {
    ...
    mvPlay: function() {
      ...
      $.ajax({
        ...
        async: false,
        url:
          "https://h5vv.video.qq.com/getinfo?callback=tvp_request_getinfo_callback_958739&platform=11001&charge=0&otype=json&ehost=https%3A%2F%2Fy.qq.com&sphls=0&sb=1&nocache=0&_rnd=1508231258&guid=caba3476fea723d4917764915c8c5950&appVer=V2.0Build9449&vids=" +
          this.vid +
          "&defaultfmt=auto&&_qv_rmt=ZWly3as6A10215Uqd=&_qv_rmt2=gZ2qaP05158328nUg=&sdtfrom=v3010",
        dataType: "jsonp",
        jsonp: "callback",
        ...
        success: function(data) {
          _this.videoSrc =
            "http://117.169.70.150/music.qqvideo.tc.qq.com/AcpQM5yib1MARJ5HCSr5FQAW7NygnyyFyGiujpLJxa5I/" +
            _this.vid +
            ".mp4?vkey=" +
            data.vl.vi[0].fvkey +
            "&br=122&platform=2&fmt=auto&level=0&sdtfrom=v3010&guid=caba3476fea723d4917764915c8c5950";
          console.log(data);
