    ...
    methods: {
      cartView: function(done) {
        ...
        $.ajax({
          type: "get",
          async: false,
          url: "https://c.y.qq.com/v8/fcg-bin/getmv_by_tag?g_tk=5381&jsonpCallback=getMvlist&loginUin=0&hostUin=0&format=jsonp&inCharset=utf8&outCharset=utf-8&notice=0&platform=yqq&needNewCode=0&utf8=1&type=" + _this.sortType + "&year=" + _this.yearTit + "&area=" + _this.areaTit + "&tag=" + _this.tagTit + "&pageno=" + _this.pagenoTit + "&pagecount=" + _this.pagecountTit + "&taglist=" + _this.taglistTit,
          dataType: "jsonp",
          jsonp: "callback",
